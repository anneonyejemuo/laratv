                            ...
                            <?php if($subscription === "1" && $this->session->subscriber !== true) { ?>
                                <div class="video-header text-center">
                                    ...
                                    <div class="col-sm-12 col-md-4 col-md-offset-4">
                                        <a href="<?php echo ($this->session->url) ? site_url('user/subscription/' . $this->session->url . '/') : site_url('login/register/'); ?>" class="btn btn-green btn-slider waves-effect waves-light btn-lg"><?php echo $this->lang->line('Signup Now to Become Subscriber') ?></a>
